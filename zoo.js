...
//sorting the anials array based on their name
...
// display animals with higherendfunctions
// animal of the month
displayAnimalAges(ages);

animals.sort(function compareName(a, b) {
  return a - b;
});

ages.sort(function compareAge(a, b) {
  return a - b;
});
